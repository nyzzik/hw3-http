...
//---------------------------------------------------------------------------------
// Uses hostname to get the host. Creates a socket and connects to it. If the connect method returns -1, an error occured and it closes the socket and returns -1. Otherwise it returns the socket.
//
//
//---------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------
// Separates the http header from the http buffer. Finds the index at which the HTTP_HEADER_END is in the http buffer. If the index doesnt exist it returns -1. Otherwise it calculates the header len and returns it.
//
//---------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------
// Gets the length of the content in the http buffer. Iterates over the headerline until it finds the content length. It will return the content length. If it cannot find the content length it will return 0.
//
//---------------------------------------------------------------------------------
