...
int submit_request(int sock, const char *host, uint16_t port, char *resource)
{
    ...
    // from the server
    //
    // YOUR ANSWER:  It gets the length of the data excluding the header and content.
    //
    //--------------------------------------------------------------------------------
    ...
    //
    // YOUR ANSWER:  It should return the socket in case it had to be reopened since it will have a different socket id and with KA, we keep the socket open and just reuse it.
    //
    //--------------------------------------------------------------------------------
    return sock;
}
